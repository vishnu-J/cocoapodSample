...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_PROTOCOL("_TtP3ios21CampaignStateListener_")
...
SWIFT_CLASS("_TtC3ios15FloatRatingView")
...
typedef SWIFT_ENUM(NSInteger, FloatRatingViewType) {
/// Integer rating
...
SWIFT_PROTOCOL("_TtP3ios23FloatRatingViewDelegate_")
@protocol FloatRatingViewDelegate
@optional
...
SWIFT_CLASS("_TtC3ios15GreedyGameAgent")
@interface GreedyGameAgent : NSObject
- (void)initWithGameId:(NSString * _Nonnull)gameId stateListener:(id <CampaignStateListener> _Nullable)stateListener SWIFT_METHOD_FAMILY(none);
...
@interface GreedyGameAgent (SWIFT_EXTENSION(ios))
@end
...
SWIFT_CLASS("_TtC3ios14PrivacyOptions")
@interface PrivacyOptions : NSObject
